...
class MlpPolicy(object):
    ...
    def act(self, stochastic, ob, option):
        ac1, vpred1, vpred_ent1, feats, logstd =  self._act(stochastic, ob[None], [option])
        return ac1[0], vpred1[0], vpred_ent1[0], feats[0], logstd[option][0]
